...
## Downward looking camera
 ...
 - SDK 3.0 firmware info: *I got response from Ryze support. You can switch between forward and downward facing camera with the folllowing commands (requires firmware v02.05.01.17)*

## ESP32  controller:
 - [ROS support for ESP32 controller](https://discourse.ros.org/t/micro-ros-porting-to-esp32/16101)
